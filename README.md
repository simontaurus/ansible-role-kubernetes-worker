...
# specified here. If you have a loadbalancer the distributes traffic
# between all Kubernetes API servers it should be specified here.
k8s_api_server: "{{ hostvars[groups['k8s_controller'][0]]['ansible_' + hostvars[ansible_hostname]['k8s_interface']].ipv4.address }}:{{ k8s_apiserver_secure_port }}"
